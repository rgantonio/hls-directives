# Lesson 2.1 - ARRAY_PARTITION
#
#   vitis_hls -f run_hls.tcl 2>&1 | tee run.log
#
# Four solutions live in one project. Only the ARRAY_PARTITION directive on
# the argument x of the function sum4 differs between them.
...
foreach sol {base cyclic4 block4 complete} {
    ...
    # Partitioning changes which port and which address hold each element of
    # x, which only the RTL shows. Co-simulation checks that mapping in every
    # solution.
    cosim_design
}
