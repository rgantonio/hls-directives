...
// summed an element from the wrong bank or the wrong address shows a wrong
// bit pattern. Fixed-seed random cases follow. Values stay small enough that
// no sum of four elements overflows.
